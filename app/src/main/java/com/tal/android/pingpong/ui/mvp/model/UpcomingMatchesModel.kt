...
class UpcomingMatchesModel(private val sharedPreferences: SharedPreferencesUtils) : BaseEventsModel() {
    ...
    fun fetchUserMatches() {
        ...
        matchesService
            .getMyMatches(userId = userId, startDate = Date().time, endDate = null)
